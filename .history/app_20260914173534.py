...
ئێستا دەتوانیت بە ئاسانی کۆدەکە کۆپی بکەیت و لە پڕۆگرامەکەتدا دایبنێیت و بێ هیچ کێشەیەک کاردەکات!فەرموو، ئەوەش کۆدی تەواو و پاککراوەی بەرنامەکەت. کێشە بچووکەکەی بەشی `messagebox` ڕاستکرایەوە و ئێستا بە شێوازێکی زانستی و بێ کێشە کار دەکات:
...
class DocumentApp(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        ctk.CTkLabel(self.frame_form, text="بەروار:").pack(anchor="w", padx=10)
        self.entry_date = ctk.CTkEntry(self.frame_form, placeholder_text="YYYY-MM-DD")
        self.entry_date.insert(0, datetime.now().strftime("%Y-%m-%d"))
        self.entry_date.pack(fill="x", padx=10, pady=5)
