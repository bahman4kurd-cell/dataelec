...
class PartyApp:
    ...
    def __init__(self, root):
        ...
        tk.Label(
            input_frame,
            text="ڕەنگ (نموونە: red یا #ff0000):",
            font=("Arial", 10),
            bg="#f0f0f0",
        ...
        lbl_credit.grid(row=1, column=0, columnspan=7, pady=5)
    ...
    def update_chart(self):
        ...
        # تەنها لە چارتەکانی Bar و Pie ڕەنگەکان و دەنگەکان وەک خۆیان لە داتابەیسەوە بەکاردێن
        if chart_type == "Bar":
            ...
            # لە جۆرەکانی تری چارت (وەک هێڵی) ڕەنگی تایبەتی تاکەکەسی وەرناگرێت بەڵکو بە شێوازی ستاندارد دەردەکەوێت
            ax.plot(parties, votes, marker='o', color='teal', linewidth=2.5, markersize=6)
            ax.set_ylabel("ژمارەی دەنگ")
            ax.set_title("چارتی هێڵی دەنگی لایەنەکان")
            plt.xticks(rotation=15)
