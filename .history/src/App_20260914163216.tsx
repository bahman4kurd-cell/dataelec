        ...
        <main className="flex-1 p-6 overflow-y-auto">
          ...
          {activeTab === 'dashboard' && (
            <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl p-6 shadow-sm">
              ...
              <p className="text-[var(--text-secondary)] text-sm">ئامادەیە بۆ زیادکردنی هێڵکارییەکان لە هەنگاوی دووەمدا.</p>
            </div>
          )}
          ...
          {activeTab === 'parties' && (
            <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl p-6 shadow-sm">
              ...
              <p className="text-[var(--text-secondary)] text-sm">لیستی لایەنەکان و ڕەنگەکانیان لێرە بەڕێوەدەبرێن.</p>
            </div>
          )}
        </main>
      </div>
