...
export default App;
```بە پێی کێشەکە کە باست کرد، دوو کێشەی سەرەکی لە کۆدەکەتدا هەن:
1. **نیشاننەدانی ڕەنگ و نەگۆڕانی جۆری چارتەکە (Chart Type / Colors):** کێشەی نەگونجانی ڕەنگەکان یان نوێبوونەوەی چارتەکە بەهۆی ئەوەیە کە کۆنترۆڵەکان یان داتاکانی ماتپڵۆتلایب (Matplotlib) یان تکینتەر (Tkinter) دووبارە ڕێک نەخراونەتەوە یان Canvas بە شێوازێکی دروست نوێ نەبووەتەوە (Clear/Draw نەبووە).
2. **سڕینەوەی داتا لەگەڵ هەر جارێک داخڵکردن (Data Persistence):** چونکە داتاکە تەنها لە مۆریۆری (Memory) بەرنامەکە یان فڕەیمەکاندا هەڵدەگیرێت و لە داتابەیس (SQLite) بە شێوازێکی تەواو و هەمیشەیی پاشەکەوت ناکرێت، یان کاتی داخڵکردن کۆمیت (Commit) و جێگیر ناکرێت.

لەم ڤێرژنەی خوارەوەدا، هەموو کێشەکان چارەسەر کراون:
* **داتابەیسی SQLite