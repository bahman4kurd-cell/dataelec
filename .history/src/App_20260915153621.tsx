...
export function App() {
  ...
  // پشکنینی پاشەکەوتی پێشوو (Remember Me) لە localStorage
  useEffect(() => {
  ...
  // ئەگەر لۆگین نەکراوە، پەڕەی لۆگین یان گەڕاندنەوەی پاسۆرد نیشان بدە
  if (!isLoggedIn) {
    return (
  ...
  // ئەگەر لۆگین سەرکەوتبوو، سیستەمی فەرمی خۆی نیشان بدە لەگەڵ دوگمەی دەرچوون (Logout)
  return (
