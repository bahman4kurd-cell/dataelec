...
export function App() {
  ...
  const defaultParties = [
    { partyId: 1, partyName: 'پارتی دیموکراتی کوردستان', color: 'bg-yellow-400', hexColor: '#eab308' },
    { partyId: 2, partyName: 'یەکێتی نیشتمانی کوردستان', color: 'bg-green-600', hexColor: '#16a34a' },
    { partyId: 3, partyName: 'نەوەی نوێ', color: 'bg-amber-400', hexColor: '#f97316' },
          ...
          {activeMainTab === 'dashboard' && (
            <div className="space-y-6">
              ...
              <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl p-6 shadow-sm space-y-6">
                ...
                {/* پای چارت و دۆنەت چارت بە شێوازی SVG Path زانستی، پاک، و لیستی لایەنەکان بە شێوەی ئاسۆیی بێ سکرۆڵ بەیەکجار */}
