...
export function App() {
  ...
  // بۆ گۆڕینی پاسوۆرد لە ناو پەڕەی پۆفایڵ/کۆنتڕۆڵ
  const [selfNewPassword, setSelfNewPassword] = useState('');
  const [selfPasswordMsg, setSelfPasswordMsg] = useState('');

  useEffect(() => {
    localStorage.setItem('election_users_v4', JSON.stringify(users));
    // ئەگەر یوزەری ئێستا گۆڕانکاری بەسەردا هات (وەک پاسوۆرد)، نوێی بکەرەوە لێرەشدا
    if (currentUser) {
  ...
  // گۆڕینی پاسوۆرد بۆ ئەدمینی لق یان هەر یوزەرێکی تر بۆ خۆی
  ...
  // گۆڕینی پاسوۆرد لەلایەن سوپەر ئەدمینەوە بۆ هەر یوزەرێک
  ...
  const defaultParties = [
    { partyId: 1, partyName: 'PDKپارتی دیموکراتی کوردستان', color: 'bg-yellow-500', hexColor: '#eab308' },
    { partyId: 2, partyName: 'YNKیەکێتی نیشتمانی کوردستان', color: 'bg-green-600', hexColor: '#16a34a' },
