...
export function App() {
  ...
  // فلتەری لایەنەکان بە چێک بۆکس (بە شێوەیەک سەرەتا هەموویان هەڵبژێردراون)
  ...
  // کۆمەڵکردنی دەنگەکان لەسەر بنەمای فلتەری لق، ناوچە و لایەنە هەڵبژێردراوەکان
  const getFilteredDashboardVotes = () => {
    ...
    targetBranchIds.forEach(bId => {
      const branchRegions = dashSelectedRegion === 'all' 
        ? regions.filter(reg => reg.branchId === bId)
        : regions.filter(reg => reg.branchId === bId && reg.id === Number(dashSelectedRegion));
      ...
      } else if (dashSelectedRegion === 'all') {
    ...
    // تەنها ئەو لایەنانە نیشان دەدات کە لە چێک بۆکسەکەدا هەڵبژێردراون
            ...
            <div className="space-y-6">
              <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl p-6 shadow-sm space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                  ...
                  {/* فلتەری لایەنەکان بە چێک بۆکس لە ناو کۆمبۆ بۆکسێکدا */}
                  <div className="relative">
