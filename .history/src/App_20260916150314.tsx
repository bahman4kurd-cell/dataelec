...
const translations = {
  ckb: {
    ...
    filterBranchLabel: 'بەپێی لقی هەڵبژاردن ',
...
export function App() {
  ...
  const getFilteredDashboardVotes = () => {
    ...
    dashSelectedBranchIds.forEach(bId => {
      // ئەگەر ناوچە هەڵبژێردرابێت بۆ ئەم لقە، دەنگەکانی ناوچەکان کۆبکەوە
      ...
      // هەروەها دەنگە ڕاستەوخۆکانی لقیش کۆبکەوە (بۆ ئەوەی داتاکان نێڕژێن و ون نەبن)
  ...
  // ناوچەکانی سەر بە لقە هەڵبژاردراوەکانی داشبۆرد بۆ مەبەستی فلتەرکردن
