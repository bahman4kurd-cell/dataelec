    ...
    <div className="min-h-screen flex flex-col bg-[var(--bg-main)] text-[var(--text-primary)] transition-colors duration-200" dir={getDir()}>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 p-6 overflow-y-auto space-y-6">
          ...
          {/* بەشی نوێکراو و تەواوکراوی تابی ڕاپۆرتەکان */}
          {activeMainTab === 'reports' && (
            <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-[var(--border-color)] pb-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-4 py-2 rounded-lg text-sm shadow transition"
                    >
              ...
              {/* کەرتی فەرمی ڕاپۆرت و چاپکردن */}
              <div ref={reportRef} className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl p-8 shadow-md space-y-8 print:border-none print:shadow-none print:p-0">
                <div className="border-b-2 border-gray-300 pb-4 flex justify-between items-center">
                  <div>
                    <h2 className="text-2xl font-bold">{t.systemTitle}</h2>
                    <p className="text-sm text-[var(--text-secondary)] mt-1">
                      ڕاپۆرتی فەرمی ئەنجامەکانی خولی: <span className="font-bold text-blue-600">{repSelectedRoundObj?.name || '---'}</span>
                    </p>
                  </div>
                  <div className="text-end">
                    <span className="text-xs font-semibold block text-[var(--text-secondary)]">بەرواری چاپ:</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="space-y-4">
                    <h3 className="text-base font-bold text-[var(--text-secondary)] border-b pb-2">پوختەی هەڵبژاردن</h3>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between py-1 border-b border-[var(--border-color)]">
                        <span>خولی هەڵبژاردن:</span>
                        <span className="font-bold">{repSelectedRoundObj?.name || 'دیاری نەکراوە'}</span>
                      </div>
                      <div className="flex justify-between py-1 border-b border-[var(--border-color)]">
                        <span>جۆری هەڵبژاردن:</span>
                        <span className="font-bold">{repSelectedRoundObj?.type || '---'}</span>
                      </div>
                      <div className="flex justify-between py-1 border-b border-[var(--border-color)]">
                        <span>کۆی گشتی دەنگە ژماردرابووەکان:</span>
                        <span className="font-bold text-blue-600">{totalReportVotes.toLocaleString()} دەنگ</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-center">
                    <div className="relative w-64 h-64">
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center text-center pointer-events-none">
                        <span className="text-[10px] text-[var(--text-secondary)]">کۆی دەنگەکان</span>
                        <span className="text-xs font-bold">{totalReportVotes.toLocaleString()}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h3 className="text-lg font-bold mb-4">{t.partyNameHeader} و وردکاری دەنگەکان</h3>
                  <div className="overflow-x-auto">
                    <table className="w-full text-start border-collapse">
                      <thead>
                        <tr className="bg-[var(--bg-main)] border-y border-[var(--border-color)] text-sm">
                          <th className="py-3 px-4 text-start">لایەن / قەوارە</th>
                          <th className="py-3 px-4 text-center">ژمارەی دەنگەکان</th>
                          <th className="py-3 px-4 text-center">ڕێژەی سەدی</th>
                          <th className="py-3 px-4 text-start">دیagram / ئاستی دەنگ</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-[var(--border-color)] text-sm">
                        {reportData.map((item) => (
                          <tr key={item.partyId} className="hover:bg-[var(--bg-hover)]">
                            ...
                            <td className="py-3 px-4 text-center font-bold">{item.votes.toLocaleString()}</td>
                            <td className="py-3 px-4 text-center font-bold text-blue-600">{item.percentage}%</td>
