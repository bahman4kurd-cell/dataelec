        ...
        <main className="flex-1 p-6 overflow-y-auto space-y-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {currentRegions.length === 0 ? (
                          <div className="w-full space-y-4">
                            ...
                            {/* داخڵکردنی دەنگەکان لەسەر ئاستی لق */}
                            <div className="bg-[var(--bg-main)] border border-[var(--border-color)] rounded-xl p-5 space-y-4">
                              ...
                              {currentUser.role !== 'viewer' && (
                                <form onSubmit={handleAddNewParty} className="bg-[var(--bg-card)] p-3 rounded-xl border border-[var(--border-color)] flex items-center gap-3">
                                  <input 
                                    type="text" 
                                    placeholder="ناوی لایەنی نوێ بنووسە..."
                                    value={newPartyName}
                                    onChange={(e) => setNewPartyName(e.target.value)}
                                    className="flex-1 bg-[var(--bg-main)] border border-[var(--border-color)] rounded-lg px-3 py-1.5 text-sm"
                                    required
                                  />
                                  <div className="flex items-center gap-1">
                                    <label className="text-xs text-[var(--text-secondary)] font-medium">ڕەنگ:</label>
                                    <input 
                                      type="color" 
                                      value={newPartyColor}
                                  ...
                                  <button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-1">
                                    ...
                                    <div className="flex items-center gap-4 w-full sm:w-auto justify-end">
                                      <div className="flex items-center gap-2">
                                        ...
                                        <input
                                          ...
                                          className="w-28 bg-[var(--bg-main)] border border-[var(--border-color)] rounded px-2 py-1 text-sm font-bold text-blue-600 focus:ring-2 focus:ring-blue-500 disabled:opacity-60"
                                        />
                                      </div>
                                      <div className="text-xs font-bold text-emerald-600 w-16 text-end">
                                        {party.percentage}%
                                      </div>
                                      {currentUser.role !== 'viewer' && (
                                        <button 
                                          onClick={() => handleDeleteParty(party.partyId)}
                                          title="سڕینەوەی لایەن"
                                          className="text-red-500 hover:text-red-700 hover:bg-red-100 dark:hover:bg-red-950 p-1 rounded transition-colors"
                                        >
          ...
          {activeMainTab === 'controlPanel' && (
            <div className="space-y-6">
              {currentUser.role === 'super_admin' && (
                <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl p-6 shadow-sm space-y-4">
                  <div className="border-b border-[var(--border-color)] pb-3">
                    ...
                    <p className="text-xs text-[var(--text-secondary)] mt-1">{t.controlPanelSubtitle}</p>
                  </div>
                  ...
                  <form onSubmit={handleCreateAccount} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    <div>
                      <label className="block text-xs font-bold text-[var(--text-secondary)] mb-1">{t.fullNameLabel}</label>
                      <input 
                        type="text" 
                        value={newAccName} 
                        onChange={(e) => setNewAccName(e.target.value)} 
                        placeholder="بەڕێوەبەری لقی سلێمانی" 
                        className="w-full bg-[var(--bg-main)] border border-[var(--border-color)] rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500" 
                        required 
                      />
                    </div>
                    ...
                    <div>
                      <label className="block text-xs font-bold text-[var(--text-secondary)] mb-1">{t.username}</label>
                      <input 
                        type="text" 
                        value={newAccUsername} 
                        onChange={(e) => setNewAccUsername(e.target.value)} 
                        placeholder="sulaymaniyah_admin" 
                        className="w-full bg-[var(--bg-main)] border border-[var(--border-color)] rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500" 
                        required 
                      />
                    </div>
                    ...
                    <div>
                      <label className="block text-xs font-bold text-[var(--text-secondary)] mb-1">{t.password}</label>
                      <input 
                        type="text" 
                    ...
                    <div>
                      <label className="block text-xs font-bold text-[var(--text-secondary)] mb-1">{t.roleLabel}</label>
                      <select 
                        value={newAccRole} 
                    ...
                    <div>
                      <label className="block text-xs font-bold text-[var(--text-secondary)] mb-1">لقی پەیوەندیدار</label>
                      <select 
                    ...
                    <div className="lg:col-span-5 flex justify-end">
                      <button type="submit" className="bg-amber-600 hover:bg-amber-700 text-white font-bold px-6 py-2 rounded-lg text-sm transition">
                        {t.createAccountBtn}
                      </button>
                    </div>
                  </form>
                ...
                <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl p-6 shadow-sm space-y-4">
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-start border-collapse">
                      <thead>
                        <tr className="border-b border-[var(--border-color)] text-[var(--text-secondary)] text-sm">
                          <th className="py-3 px-4">ناوی تەواو</th>
                            ...
                            <tr key={u.id} className="hover:bg-[var(--bg-hover)]">
                              ...
                              <td className="py-3 px-4 font-mono text-blue-600 font-bold">
                                <input
                                  ...
                                  className="bg-[var(--bg-main)] border border-[var(--border-color)] rounded px-2 py-0.5 text-xs w-28"
                                />
                              </td>
                              <td className="py-3 px-4">
                                <span className={`px-2 py-0.5 rounded text-xs font-bold ${
                                  u.role === 'super_admin' ? 'bg-purple-100 text-purple-800' :
                                  u.role === 'branch_admin' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'
                                }`}>
                                  {u.role}
                                </span>
                              </td>
                              ...
                              <td className="py-3 px-4">
                                {u.id !== 1 && (
                                  <button onClick={() => handleDeleteUser(u.id)} className="text-red-600 hover:underline text-xs font-bold">
                                    {t.deleteBtn}
                                  </button>
                                )}
                              </td>
              ...
              {currentUser.role === 'branch_admin' && (
                <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl p-6 shadow-sm space-y-4 max-w-xl">
                  <div className="border-b border-[var(--border-color)] pb-3">
                    <h2 className="text-xl font-bold">{t.changeMyPasswordTitle}</h2>
                    <p className="text-xs text-[var(--text-secondary)] mt-1">{t.changeMyPasswordSubtitle}</p>
                  </div>
                  ...
                  <form onSubmit={handleUpdateMyPassword} className="space-y-4">
                    ...
                    <button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-2.5 rounded-lg text-sm transition">
          ...
          {activeMainTab === 'reports' && currentUser.role !== 'viewer' && (
            <div className="space-y-6">
              <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl p-6 shadow-sm space-y-6 print:hidden">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-[var(--border-color)] pb-4">
                  <div>
                    ...
                    <p className="text-xs text-[var(--text-secondary)] mt-1">{t.reportsSubtitle}</p>
                  </div>

                  <div className="flex items-center gap-3">
                    <button onClick={handlePrintReport} className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-4 py-2 rounded-lg text-sm flex items-center gap-2 shadow">
                      {t.printReportBtn}
                    </button>
                    <button onClick={handleDownloadPdf} className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-4 py-2 rounded-lg text-sm flex items-center gap-2 shadow">
                      {t.downloadPdfBtn}
                    </button>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-xs font-bold text-[var(--text-secondary)] mb-1">خولی هەڵبژاردن</label>
                    <select
                      value={repSelectedRoundId || ''}
                      onChange={(e) => setRepSelectedRoundId(Number(e.target.value) || null)}
                      className="w-full bg-[var(--bg-main)] border border-[var(--border-color)] rounded-lg px-3 py-2 text-sm font-semibold"
                    >
                      {rounds.map(r => (
                  ...
                  <div className="relative">
                    <label className="block text-xs font-bold text-[var(--text-secondary)] mb-1">{t.filterBranchLabel}</label>
                    <div 
                      onClick={() => {
                        if (currentUser.role !== 'branch_admin' && currentUser.role !== 'viewer') {
                    ...
                    {isRepBranchOpen && (
                      <div className="absolute z-20 mt-1 w-full bg-[var(--bg-card)] border border-[var(--border-color)] rounded-lg shadow-xl p-3 space-y-2 max-h-60 overflow-y-auto">
                        <div className="flex items-center justify-between border-b border-[var(--border-color)] pb-2 mb-2">
                          <button type="button" onClick={() => setRepSelectedBranchIds(repFilteredBranches.map(b => b.id))} className="text-xs text-blue-500 font-bold hover:underline">هەمووی هەڵبژێرە</button>
                          <button type="button" onClick={() => { setRepSelectedBranchIds([]); setRepSelectedRegionIds([]); }} className="text-xs text-red-500 font-bold hover:underline">هیچیان هەڵمەبژێرە</button>
                        </div>
                        {repFilteredBranches.map(branch => {
                          ...
                          return (
                            <div 
                              ...
                              onClick={() => {
                                if (isChecked) {
                                  setRepSelectedBranchIds(repSelectedBranchIds.filter(id => id !== branch.id));
                                } else {
                              ...
                              className="flex items-center gap-2 text-xs font-semibold cursor-pointer hover:bg-[var(--bg-hover)] p-1.5 rounded"
                            >
                              {isChecked ? <CheckSquare className="w-4 h-4 text-blue-600" /> : <Square className="w-4 h-4 text-gray-400" />}
                              <span className="truncate">{branch.name}</span>
                            </div>
                          );
                        })}
                  ...
                  <div className="relative">
                    <label className="block text-xs font-bold text-[var(--text-secondary)] mb-1">{t.filterAreaLabel}</label>
                    <div 
                      onClick={() => {
                    ...
                    {isRepRegionOpen && (
                      <div className="absolute z-20 mt-1 w-full bg-[var(--bg-card)] border border-[var(--border-color)] rounded-lg shadow-xl p-3 space-y-2 max-h-60 overflow-y-auto">
                        <div className="flex items-center justify-between border-b border-[var(--border-color)] pb-2 mb-2">
                          <button type="button" onClick={() => setRepSelectedRegionIds(repFilteredRegions.map(r => r.id))} className="text-xs text-blue-500 font-bold hover:underline">هەمووی هەڵبژێرە</button>
                          <button type="button" onClick={() => setRepSelectedRegionIds([])} className="text-xs text-red-500 font-bold hover:underline">هیچیان هەڵمەبژێرە</button>
                        </div>
              ...
              <div ref={reportRef} className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl p-8 shadow-md space-y-6 print:border-none print:shadow-none print:p-0">
                <div className="text-center border-b border-[var(--border-color)] pb-6 space-y-2">
                  <h2 className="text-2xl font-black">ڕاپۆرتی کۆتایی ئەنجامەکانی هەڵبژاردن</h2>
                  <p className="text-sm font-semibold text-blue-600">{repSelectedRoundObj?.name || '---'}</p>
                  <p className="text-xs text-[var(--text-secondary)]">بەروار: {new Date().toLocaleDateString('fa-IR')}</p>
                </div>

                <div className="flex justify-between items-center bg-[var(--bg-main)] p-4 rounded-xl border border-[var(--border-color)]">
                  <span className="font-bold text-sm">کۆی گشتی دەنگە دروستەکان لەسەر ئاستی بەشداربووان:</span>
                  <span className="font-extrabold text-lg text-blue-600">{totalReportVotes.toLocaleString()} دەنگ</span>
                </div>

                <div className="overflow-x-auto">
                  <table className="w-full text-start border-collapse border border-[var(--border-color)]">
                    <thead>
                      <tr className="bg-[var(--bg-main)] text-sm border-b border-[var(--border-color)]">
                        <th className="py-3 px-4 border-e border-[var(--border-color)] text-start">#</th>
                        <th className="py-3 px-4 border-e border-[var(--border-color)] text-start">{t.partyNameHeader}</th>
                        <th className="py-3 px-4 border-e border-[var(--border-color)] text-start">ژمارەی دەنگ</th>
                        <th className="py-3 px-4 text-start">ڕێژەی سەدی (%)</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-[var(--border-color)] text-sm">
                      {reportData.map((item, idx) => (
                        <tr key={item.partyName} className="hover:bg-[var(--bg-hover)]">
                          <td className="py-2.5 px-4 border-e border-[var(--border-color)] font-bold">{idx + 1}</td>
                          <td className="py-2.5 px-4 border-e border-[var(--border-color)] font-semibold flex items-center gap-2">
                            <span className="w-3.5 h-3.5 rounded-full border border-gray-300" style={{ backgroundColor: item.hexColor }}></span>
                            <span>{item.partyName}</span>
                          </td>
                          <td className="py-2.5 px-4 border-e border-[var(--border-color)] font-mono font-bold text-blue-600">{item.votes.toLocaleString()}</td>
                          <td className="py-2.5 px-4 font-bold text-emerald-600">{item.percentage}%</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                ...
                <div className="pt-8 border-t border-[var(--border-color)] flex justify-between text-xs text-[var(--text-secondary)] font-semibold">
                  <span>سیستەمی شیکاری ئەنجامەکانی هەڵبژاردن</span>
                  <span>ئیمزا و پشتمانپێبەستنی کۆتایی</span>
                </div>
              </div>
            </div>
          )}
